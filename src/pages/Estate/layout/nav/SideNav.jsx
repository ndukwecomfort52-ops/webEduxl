...
const Sidebar = ({ navData, isSidebarOpen, toggleSidebar }) => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed lg:fixed top-0 left-0 z-50 h-screen w-72
      ...
      >
        ...
        {/* Navigation */}
        <nav className="flex flex-col h-[calc(100vh-88px)] justify-between py-6">
          {/* Main Navigation */}
